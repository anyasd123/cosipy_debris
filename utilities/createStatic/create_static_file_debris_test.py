...
dem_path_tif = static_folder + 'DEM/Khumbu_DEM.tif'
...
output_path = static_folder + 'Khumbu_static_30m_debris.nc'
### input debris cover/thickness from David Rounce
debris_path_tif = static_folder + 'Debris/Rounce_debris_latlon.tif'
### input debris cover/thickness from Ann Rowan
#rowan_path_tif = static folder +'Debris/Rowan_Debris.tif'

#### to shrink the DEM usethe following lat/lon corners
longitude_upper_left = '86.75014'
latitude_upper_left = '28.01486'
longitude_lower_right = '86.93986'
latitude_lower_right = '27.92614'

#aggregate the DEM to a coarser spatial resolution
aggregate_degree = '0.0002708'

### to aggregate the debris to a coarser spatial resolution
aggregate_degree_debris = '0.0002708'
...
debris_path = static_folder + 'debris.nc'
debris_path_tif_temp = static_folder + 'debris_temp.tif'
debris_path_tif_temp2 = static_folder + 'debris_temp2.tif'
...
### If you do not want to aggregate debris, comment out the following to two lines
if aggregate:
    os.system('gdalwarp -tr ' + aggregate_degree_debris + ' ' + aggregate_degree_debris + ' -r average ' + debris_path_tif + ' ' + debris_path_tif_temp)
    debris_path_tif = debris_path_tif_temp
...
if tile:
    os.system('gdal_translate -r cubicspline -projwin ' + longitude_upper_left + ' ' + latitude_upper_left + ' ' +
         longitude_lower_right + ' ' + latitude_lower_right + ' ' + dem_path_tif + ' ' + dem_path_tif_temp2)
    dem_path_tif = dem_path_tif_temp2

### If you do not want to shrink the debris, comment out the following to three lines
if tile:
    os.system('gdal_translate -r cubicspline -projwin ' + longitude_upper_left + ' ' + latitude_upper_left + ' ' +
         longitude_lower_right + ' ' + latitude_lower_right + ' ' + debris_path_tif + ' ' + debris_path_tif_temp2)
    debris_path_tif = debris_path_tif_temp2
...
###### Add line to convert debris to netcdf
os.system('gdal_translate -of NETCDF ' + debris_path_tif + ' ' + debris_path)
...
debris = xr.open_dataset(debris_path)
...
insert_var(ds, debris.Band1.values,'DEBRIS','meters','debris depth in meters')
...
os.system('rm '+ dem_path + ' ' + aspect_path + ' ' + mask_path + ' ' + slope_path + ' ' + dem_path_tif_temp + ' '+ dem_path_tif_temp2 + ' ' + debris_path + ' ' + debris_path_tif_temp + ' ' + debris_path_tif_temp2)
